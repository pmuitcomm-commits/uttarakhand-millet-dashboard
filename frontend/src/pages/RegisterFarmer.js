...
const cardClass =
  "flex w-full max-w-[1160px] flex-col rounded-[20px] border border-[#024b37]/[0.07] bg-white px-10 pb-12 pt-9 shadow-form-card max-[1100px]:px-7 max-[1100px]:pb-10 max-[1100px]:pt-7 max-[768px]:rounded-2xl max-[768px]:px-5 max-[768px]:pb-8 max-[768px]:pt-6 max-[640px]:max-w-none max-[640px]:rounded-none max-[640px]:border-0 max-[640px]:shadow-none max-[480px]:px-3.5 max-[480px]:pb-6 max-[480px]:pt-4 max-[320px]:px-2.5 max-[320px]:pb-[18px] max-[320px]:pt-3";
const headerClass =
...
const checkboxGridClass =
  "mb-2 grid grid-cols-3 gap-x-3.5 gap-y-2.5 max-[1100px]:grid-cols-2 max-[768px]:grid-cols-1 max-[768px]:gap-y-2 max-[480px]:gap-2";
const checkboxItemClass =
  "flex min-h-11 cursor-pointer select-none items-center gap-2.5 rounded-[10px] border-[1.5px] border-[#e0dbd0] bg-white px-3.5 py-[11px] text-[0.88rem] font-bold text-[#2a3b2e] transition duration-150 hover:border-[#024b37] hover:bg-[#f3f9f6] max-[768px]:px-3 max-[768px]:py-2.5 max-[768px]:text-[0.86rem] max-[480px]:gap-2 max-[480px]:px-[11px] max-[480px]:py-[9px] max-[480px]:text-[0.8rem] [&_input]:m-0 [&_input]:h-4 [&_input]:w-4 [&_input]:shrink-0 [&_input]:cursor-pointer [&_input]:accent-[#024b37] max-[480px]:[&_input]:h-3.5 max-[480px]:[&_input]:w-3.5";
const leaseStatusClass = "col-span-3 max-[1100px]:col-span-2 max-[768px]:col-span-1";
...
function RegisterFarmer() {
  ...
  const [formData, setFormData] = useState(initialFarmerFormData);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await registerFarmer(formatFarmerPayload(formData));
