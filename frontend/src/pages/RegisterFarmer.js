...
function RegisterFarmer() {
  ...
  const validateForm = () => {
    ...
    } else if (Number(formData.cultivation_area) <= 0 || Number.isNaN(Number(formData.cultivation_area))) {
    ...
    if (formData.lease_status === 'yes') {
      ...
      } else if (Number(formData.lease_area) <= 0 || Number.isNaN(Number(formData.lease_area))) {
  ...
  const formatPayload = () => ({
    ...
    farmer_profile: {
      ...
      cultivation_area: Number(formData.cultivation_area),
      cultivation_khatauni: formData.cultivation_khatauni.trim(),
      cultivation_khasra: formData.cultivation_khasra.trim(),
      lease_status: formData.lease_status,
      lease_cultivator_name: formData.lease_cultivator_name.trim() || null,
      lease_period: formData.lease_period.trim() || null,
      lease_khatauni: formData.lease_khatauni.trim() || null,
      lease_khasra: formData.lease_khasra.trim() || null,
      lease_area: formData.lease_status === 'yes' ? Number(formData.lease_area) : null,
    ...
    <div className="register-farmer-page">
      <div className="register-farmer-card">
        <div className="register-farmer-header">
          ...
          <button type="button" className="header-btn" onClick={() => navigate('/')}>Back to Login</button>
        </div>

        {statusMessage && (
          <div className={`status-banner ${statusMessage.includes('successfully') ? 'success' : 'error-banner'}`}>
            {statusMessage}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="register-farmer-form">
          <div className="form-section">
            ...
            <div className="form-grid">
              <div className="field-group full-width">
                <label htmlFor="full_name">Name of Farmer / Group / FPO / SHG / NRLM Group</label>
                <input
                  id="full_name"
                  name="full_name"
              ...
              <div className="field-group full-width">
                <label htmlFor="group_president_name">Name of Group President (if applicable)</label>
                <input
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              <div className="field-group">
                ...
                />
                {errors.cultivator_name && <span className="error-text">{errors.cultivator_name}</span>}
              </div>
              <div className="field-group">
                ...
                />
                {errors.cultivation_area && <span className="error-text">{errors.cultivation_area}</span>}
              </div>
              <div className="field-group">
                <label htmlFor="cultivation_khatauni">Khatauni Account Number</label>
                <input
                ...
                />
                {errors.cultivation_khatauni && <span className="error-text">{errors.cultivation_khatauni}</span>}
              </div>
              <div className="field-group">
                ...
                />
                {errors.cultivation_khasra && <span className="error-text">{errors.cultivation_khasra}</span>}
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-grid lease-grid">
              ...
              {formData.lease_status === 'yes' && (
                <>
                  <div className="field-group">
                    <label htmlFor="lease_cultivator_name">Name of Cultivator(s)</label>
                    <input
                    ...
                    />
                    {errors.lease_cultivator_name && <span className="error-text">{errors.lease_cultivator_name}</span>}
                  </div>
                  <div className="field-group">
                    ...
                    />
                    {errors.lease_period && <span className="error-text">{errors.lease_period}</span>}
                  </div>
                  <div className="field-group">
                    <label htmlFor="lease_khatauni">Khatauni Account Number</label>
                    <input
                      id="lease_khatauni"
                      name="lease_khatauni"
                    ...
                    />
                    {errors.lease_khatauni && <span className="error-text">{errors.lease_khatauni}</span>}
                  </div>
                  <div className="field-group">
                    ...
                    />
                    {errors.lease_khasra && <span className="error-text">{errors.lease_khasra}</span>}
                  </div>
                  <div className="field-group">
                    ...
                    />
                    {errors.lease_area && <span className="error-text">{errors.lease_area}</span>}
                  </div>
                </>
              )}
            </div>
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              <div className="field-group">
                <label htmlFor="estimated_seed_date">Estimated date of seed sowing</label>
                <input
                ...
                />
                {errors.estimated_seed_date && <span className="error-text">{errors.estimated_seed_date}</span>}
              </div>
              <div className="field-group">
                ...
                />
                {errors.estimated_yield && <span className="error-text">{errors.estimated_yield}</span>}
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              ...
              <div className="field-group">
                <label htmlFor="account_number">Bank account number of Farmer / Group</label>
                <input
                  id="account_number"
                  name="account_number"
              ...
              <div className="field-group full-width">
                ...
                />
                {errors.bank_address && <span className="error-text">{errors.bank_address}</span>}
              </div>
              <div className="field-group full-width">
          ...
          <div className="form-section declaration-row">
            <label className="checkbox-item declaration-checkbox">
              <input
                ...
                onChange={handleInputChange}
              />
              I declare that the information provided above is correct and complete.
            </label>
